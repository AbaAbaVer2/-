...
public class GameJFrame extends JFrame implements KeyListener,ActionListener {
    ...
    int num = rdm.nextInt(7)+1;
    String path = "PuzzelGame\\image\\animal\\animal"+num+"\\";
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } else if (obj == reloginItem)
        {
            ...
            System.out.println("更换为幕刃图片");
            Random rdm = new Random();
            int num1 = rdm.nextInt(9)+1;
            path = "PuzzelGame\\image\\girl\\girl"+num1+"\\";
            //重新加载图片
            step = 0;
            initData();
            initImage();
            ...
            System.out.println("更换为动物图片");

            Random rdm = new Random();
            int num2 = rdm.nextInt(7)+1;
            path = "PuzzelGame\\image\\animal\\animal"+num2+"\\";
            //重新加载图片
            step = 0;
            initData();
            initImage();
            ...
            System.out.println("更换为运动图片");
            Random rdm = new Random();
            int num3 = rdm.nextInt(9)+1;
            path = "PuzzelGame\\image\\sport\\sport"+num3+"\\";
            //重新加载图片
            step = 0;
            initData();
            initImage();
        } else if (obj == goodjobteamItem) {
            System.out.println("更换为好事群图片");

            Random rdm = new Random();
            int num4 = rdm.nextInt(6)+1;
            path = "PuzzelGame\\image\\GoodJobTeam\\"+num4+"\\";
            //重新加载图片
            step = 0;
            initData();
            initImage();
